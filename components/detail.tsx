            ...
            <div className="relative">
                <div className="w-screen flex justify-center">
                    <Image
                        ...
                        width={800}
                        height={0}
                        className="mb-10 md:mt-20 md:ml-[380px]"
                    />
                </div>
                <div className="absolute w-[95%] top-[80%] left-[4%] md:w-[550px] md:top-[27%] md:left-[10%]">
                    <div className="border-2 bg-white w-[96%] p-2 rounded-xl">
                        <p className="text-[#FF9900] font-bold text-6xl px-4 md:text-8xl">01</p>
                        <h3 className="text-3xl p-2 font-bold md:text-5xl">
                            学生が企業と<br />
            ...
            <div className="relative">
                <div className="w-screen flex justify-center">
                    <Image
                        ...
                        width={800}
                        height={0}
                        className="my-10 md:mt-20 md:mr-[380px]"
                    />
                </div>
                <div className="absolute w-[95%] top-[80%] left-[4%] md:w-[550px] md:left-[58%] md:top-[27%]">
                    <div className="border-2 bg-white w-[96%] p-2 rounded-xl">
                        <p className="text-[#FF9900] font-bold text-6xl px-4 md:text-8xl">02</p>
                        <h3 className="text-3xl p-2 font-bold md:text-5xl">
            ...
            <div className="relative mt-16">
                <div className="w-screen flex justify-center">
                    <Image
                        ...
                        width={800}
                        height={0}
                        className="my-10 md:mt-20 md:ml-[380px]"
                    />
                </div>
                <div className="absolute w-[95%] top-[80%] left-[4%] md:w-[550px] md:top-[27%] md:left-[10%]">
                    <div className="border-2 bg-white w-[96%] p-2 rounded-xl">
                        <p className="text-[#FF9900] font-bold text-6xl px-4 md:text-8xl">03</p>
                        <h3 className="text-3xl p-2 font-bold md:text-5xl">
