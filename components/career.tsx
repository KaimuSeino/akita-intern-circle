const Career = () => {
    return (
        <section className="w-full p-4 flex flex-col justify-center items-center">
            <h3 className="mt-10 text-2xl text-center font-bold md:text-4xl">
                秋田インターンサークルは
                学生の<span className="text-[#FFAB40]">ガクチカ作り</span>と<br />
                情報提供による<span className="text-[#FFAB40]">キャリア構築</span>を実現します。
            </h3>
            <p className="py-8 text-xl md:w-[65%] text-center">
